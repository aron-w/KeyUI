...
function addon:InitializeGeneralSettings()
    ...
    set_if_nil("show_charge_cooldown", true)
    set_if_nil("show_loc_cooldown", true)
    set_if_nil("show_attack_flash", true)
    set_if_nil("show_proc_glow", true)
    set_if_nil("show_equipped_border", true)
    set_if_nil("show_pet_autocast", true)
